...
const TokenSwap: React.FC = () => {
    ...
    const fetchExchangeRate = async () => {
      if (fromToken && toToken && fromAmount && parseFloat(fromAmount) > 0) {
        ...
        try {
          ...
          const fromTokenPrice = await contracts.priceOracle.getLatestPrice(PRICE_FEEDS[fromTokenPriceFeed]);
          const toTokenPrice = await contracts.priceOracle.getLatestPrice(PRICE_FEEDS[toTokenPriceFeed]);
  ...
  const handleSwap = async () => {
    ...
    try {
      ...
      // For example:
      // const fromTokenContract = new Contract(fromToken.address, ERC20ABI, signer);
      // 
      ...
      //     parseUnits(toAmount, toToken.decimals).mul(95).div(100), // 5% slippage
      //     [contracts.weth.address, toToken.address],
      //     account,
      //     deadline,
      ...
      //   // Token to ETH
      //   await contracts.router.swapExactTokensForETH(
      //     parseUnits(fromAmount, fromToken.decimals),
      //     parseUnits(toAmount, 18).mul(95).div(100), // 5% slippage
      //     [fromToken.address, contracts.weth.address],
      //     account,
      //     deadline
      //   );
      // } else if (fromToken.symbol !== 'ETH' && toToken.symbol !== 'ETH') {
          ...
          <div className="space-y-2">
            ...
            <div className="flex gap-2">
              <Select value={fromToken.symbol} onValueChange={handleFromTokenChange}>
                <SelectTrigger className="w-[140px] border border-zinc-300 dark:border-zinc-700">
